...
#     the element at the current position. Move the current position forward by
#     that length plus the skip size. Increase the skip size by one.
#
...
pp knot(5, '3,4,1,5')
pp knot(256, '102,255,99,252,200,24,219,57,103,2,226,254,1,0,69,216')
